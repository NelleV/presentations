...
{\color{red} Varoquaux} et al., en préparation), Geiger, {\color{red}
...
de déregulation de l'expgression des gènes.
\end{itemize}}
\only<3>{
...
\item[-] {\color{red} Varoquaux}, Servant (Soumis)
\end{itemize}
}
};
...
\item[-] {\color{red} Varoquaux$^*$}, Cole$^*$, Gao$^*$ (Soumis)
\item[-] {\color{red} Varoquaux}, Purdom (Soumis)
\item[-] {\color{red} Varoquaux$^*$}, DeGraaf$^*$ et al. (En préparation) 
\end{itemize}
}
};
...
\item[-] Geiger, {\color{red} Varoquaux} et al. (En préparation)
\item[-] Paxton, {\color{red} Varoquaux}, et al. (En préparation) 
\item[-] Geiger, \dots, {\color{red} Varoquaux} (En préparation) 
\end{itemize}
}
};
