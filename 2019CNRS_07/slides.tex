...
\begin{itemize}
    ...
    {\tiny (application au {\em P. falciparum})}
\end{itemize}
\item[-] 2016-2019 Postdoctorat à {\bf UC Berkeley} (enc. E. Purdom)
\begin{itemize}
    \scriptsize
    \item[-] {\bf \color{red} Analyse fonctionnelle pour l'étude de
    données longitudinales} {\tiny (application à la dynamique de la réponse à la
    sécheresse du sorgho)}
\end{itemize}
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \scriptsize
    \item[-] Moore-Sloan data science fellow à BIDS
...
\item[-] Organisation de congrès \& conférences {\tiny (GraphXD, chaire du programme:
 SciPy,
chaire des proceedings: EuroScipy, \dots)}
\end{itemize}
}
\end{overlayarea}
...
\only<4>{%
\color{blue} Varoquaux et al. (2014)}
\only<5->{%
\bf \color{blue} Varoquaux et al. (2014)
}}
\item[-]{%
\only<1-3>{Servant, {\color{red} Varoquaux} et al. (2015)}
\only<4->{\color{blue} Servant, Varoquaux et al. (2015)}
}
\item[-]{%
\only<1-3>{%
{\color{red} Varoquaux} et al. (2015)}
\only<4-5>{%
\color{blue} Varoquaux et al. (2015)}
}
\item[-]{%
\only<1-3>{%
Servant$^*$, Varoquaux$^*$ et al. (2018)}
\only<4->{%
\color{blue} Servant$^*$, Varoquaux$^*$ et al. (2018)}
}
\item[-]{%
\only<1-3>{{\color{red} Varoquaux}, Servant (Soumis)}
\only<4->{\color{blue} Varoquaux, Servant (Soumis)}}
\item[-]{%
\only<1-3>{%
{\color{red} Varoquaux} et al. (En préparation)}
\only<4>{%
\color{blue} Varoquaux et al. (En préparation)}
\only<5->{%
...
\only<4->{%
\color{green}Ay$^*$, Bunnik$^*$, Varoquaux$^*$ et al. (2014)}
}
\item[-]{%
\only<1-3>{Ay$^*$, Bunnik$^*$, {\color{red} Varoquaux} et al. (2015)}
\only<4->{\color{green} Ay$^*$, Bunnik$^*$, Varoquaux et al. (2015)}
}
\item[-]{%
\only<1-3>{{\color{red} Varoquaux} (2018)}
\only<4->{\color{blue} Varoquaux (2018)}
}
\item[-] {%
\only<1-3>{Bunnik$^*$, Cook$^*$, {\color{red} Varoquaux} et al. (2018)}
\only<4>{\color{green}Bunnik$^*$, Cook$^*$, Varoquaux et al. (2018)}
\only<5->{\color{green} \bf Bunnik$^*$, Cook$^*$, Varoquaux et al. (2018)}
}
\end{itemize}
}
};
...
\tiny
\item[-]{%
\only<1-3>{ Giordano$^*$, Liu$^*$, {\color{red} Varoquaux$^*$}, et
al. (2017)}
\only<4->{\color{blue} Giordano$^*$, Liu$^*$, Varoquaux$^*$, et
al. (2017)}
}
\item[-]{%
\only<1-3>{%
...
\only<4->{%
\color{green} Varoquaux$^*$, Cole$^*$, Gao$^*$ (Soumis)
}}
\item[-]{%
\only<1-3>{%
{\color{red} Varoquaux}, Purdom (Soumis)}
\only<4->{%
\color{blue} Varoquaux, Purdom (Soumis)}
}
\item[-] {%
\only<1-3>{%
...
préparation)}
\only<4>{%
\color{blue} Varoquaux$^*$, DeGraaf$^*$ et al. (En
préparation)
}
\only<5->{%
...
\tiny
\item[-]{%
\only<1-3>{Geiger, {\color{red} Varoquaux} et al. (2018)}
\only<4->{Geiger, Varoquaux et al. (2018)}}
\item[-]{%
\only<1-3>{Paxton, {\color{red} Varoquaux}, et al. (En préparation)}
\only<4->{Paxton, Varoquaux, et al. (En préparation)}
}
\end{itemize}
}
};}
...
\includegraphics[width=0.15\linewidth]{images/matplotlib.png}
}
\end{flushright}
\end{overlayarea}
