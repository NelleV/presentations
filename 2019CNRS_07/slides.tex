...
\item[-] Données hétéroscedastiques, bruitées, bruits de groupes.
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{schemas/gene_regulation_final_9.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{schemas/gene_regulation_final_5.pdf}
\end{figure}
\vspace{-1em}
\begin{overlayarea}{12cm}{5cm}
...
\begin{itemize}
\footnotesize
\item[-] {\bf Défi}\quad 20,000 gènes chez l'humain;
