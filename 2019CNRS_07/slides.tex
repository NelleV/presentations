...
\item[-]{%
\only<1-2>{%
\bf {\color{red} Varoquaux}, Purdom (en préparation)}
\only<3->{%
\bf \color{blue} Varoquaux, Purdom (en préparation)}
}
\item[-] {%
\only<1-2>{%
...
\end{itemize}
\item[-] {\bf Solutions} \quad {\scriptsize Exploiter les approches multi-tâches pour
