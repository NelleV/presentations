...
\scalebox{.7}{(under review, Genome Research)}}
\only<5->{%
...
{\bf Problématique~:} \quad Mieux comprendre les mécanismes de régulation génique.

\vspace{1em}
\only<2->{{\bf Défi~:} \quad Analyser et intégrer des données hétérogènes,
hétéroscedastiques, larges et difficile à manipuler, en haute dimension pour
de l'inférence.}
